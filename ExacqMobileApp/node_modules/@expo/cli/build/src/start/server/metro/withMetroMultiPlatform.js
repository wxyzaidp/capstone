...
function withExtendedResolver(config, { tsconfig , isTsconfigPathsEnabled , isFastResolverEnabled , isExporting , isReactCanaryEnabled , isReactServerComponentsEnabled , getMetroBundler  }) {
    ...
    const resolver = isFastResolverEnabled ? (0, _createExpoMetroResolver.createFastResolver)({
        ...
        blockList: !((ref = config.resolver) == null ? void 0 : ref.blockList) ? [] : Array.isArray((ref1 = config.resolver) == null ? void 0 : ref1.blockList) ? (ref2 = config.resolver) == null ? void 0 : ref2.blockList : [
    ...
    const idFactory = ((ref4 = config.serializer) == null ? void 0 : ref4.createModuleIdFactory == null ? void 0 : ref4.createModuleIdFactory()) ?? ((id)=>id);
    ...
    const externals = [
        {
            match: (context, moduleName)=>{
                ...
                !(0, _metroOptions.isServerEnvironment)((ref = context.customResolverOptions) == null ? void 0 : ref.environment)) {
                    return false;
                }
        ...
        // Externals to speed up async split chunks by extern-ing common packages that appear in the root client chunk.
        {
            match: (context, moduleName, platform)=>{
                ...
                (0, _metroOptions.isServerEnvironment)((ref = context.customResolverOptions) == null ? void 0 : ref.environment) || // Only enable for client boundaries
            ...
            for (const external of externals){
                if (external.match(context, moduleName, platform)) {
                    if (external.replace === "empty") {
                        ...
                        const contents1 = `module.exports=$$require_external('${moduleName}')`;
                        const virtualModuleId1 = `\0node:${moduleName}`;
                        debug("Virtualizing Node.js (custom):", moduleName, "->", virtualModuleId1);
                        (0, _metroVirtualModules.getMetroBundlerWithVirtualModules)(getMetroBundler()).setVirtualModule(virtualModuleId1, contents1);
                        return {
                            type: "sourceFile",
                            filePath: virtualModuleId1
                        };
                    } else {
    ...
    const metroConfigWithCustomContext = (0, _withMetroResolvers.withMetroMutatedResolverContext)(metroConfigWithCustomResolver, (immutableContext, moduleName, platform)=>{
        ...
        if ((0, _metroOptions.isServerEnvironment)((ref = context.customResolverOptions) == null ? void 0 : ref.environment)) {
            ...
            const isReactServerComponents = ((ref1 = context.customResolverOptions) == null ? void 0 : ref1.environment) === "react-server";
